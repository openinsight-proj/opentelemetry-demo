 ...
 * @Date: 2023-03-02 17:19:50
 * @LastEditTime: 2023-03-02 20:51:42
 * @motto: Still water run deep
 * @Description: Modify here please
 * @FilePath: \opentelemetry-demo\src\frontend\components\CartItems\CartItems.tsx
 */
...
const CartItems = ({ productList, shouldShowPrice = true }: IProps) => {
  ...
  //   zipCode: '94043',
  // };
  // console.log(selectedCurrency, address);
